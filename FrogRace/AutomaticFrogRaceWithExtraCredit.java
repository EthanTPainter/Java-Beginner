import cs1.Keyboard;
public class AutomaticFrogRaceWithExtraCredit
{
	public static void main (String[] args) throws InterruptedException
	{
		boolean cheer, race = true;
		int curDis1 = 0, curDis2 = 0, totalDis1 = 0, totalDis2 = 0, laps = 0, currentlap1 = 1, currentlap2 = 1;
		...
		System.out.println("Fatigue: " + frog1.getFrogFatigue());
		System.out.println("\n------------------------\n");
		...
		System.out.println("Fatigue: " + frog2.getFrogFatigue());
		System.out.println("\n");
		...
		System.out.println("Set the number of laps for the frogs to race: " );
		laps = Keyboard.readInt();
		...
		while(race == true)
		{
			...
			if(totalDis1 >= 125 && laps > currentlap1)
			{
				totalDis1 = totalDis1 - 125;
				curDis1 = totalDis1;
				currentlap1++;
				spaces1 = "";
			}

			if(totalDis2 >= 125 && laps > currentlap2)
			{
				totalDis2 = totalDis2 - 125;
				curDis2 = totalDis2;
				currentlap2++;
				spaces2 = "";
			}
			...
			System.out.println("Total Distance: " + totalDis1 + " on lap " + currentlap1);
			System.out.println("Fatigue: " + frog1.getFrogFatigue());
			System.out.println();
			System.out.println(frog2.getFrogName() + " Statistics");
			System.out.println("Distance Jumped: " + frog2.getFrogStrength());
			System.out.println("Total Distance: " + totalDis2 + " on lap " + currentlap2);
			System.out.println("Fatigue: " + frog2.getFrogFatigue());

			if(totalDis1 >= 125 && currentlap1 == laps)
			{
				for(int i=1;i<70; i++)
				{
					System.out.println();
			...
			else if(totalDis2 >= 125 && currentlap2 == laps)
			{
				for(int i=1;i<70; i++)
				{
					System.out.println();
